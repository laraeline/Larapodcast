...
export default function Episode1({ onBack }: Episode1Props) {
  return (
    <div className="bg-[#111111] min-h-screen px-8 py-16">
      <div className="max-w-[500px] mx-auto">
        ...
        {/* Episode Title */}
        <h1 className="text-white mb-6">Episode 1 - A quick intro</h1>

        {/* Episode Description */}
        <p className="text-[#f5f3ee] mb-8">
          How design meets behaviour. What I learned at TU Delft and why listening to people's stories is where every product starts for me.
        </p>

        {/* Episode Image */}
        <div className="rounded-[25px] overflow-hidden mb-8">
          <img 
            src={imgChatGptImage27Okt20251526131}
            alt="Episode 1 - A quick intro"
            className="w-full h-auto object-cover"
          />
        </div>

        {/* Audio Player */}
        <div className="bg-[#ff6d42] rounded-[17px] h-[80px] flex items-center gap-4 px-8">
          {/* Previous Button */}
