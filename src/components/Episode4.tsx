...
export default function Episode4({ onBack }: Episode4Props) {
  return (
    <div className="bg-[#111111] min-h-screen px-8 py-16">
      <div className="max-w-[500px] mx-auto">
        ...
        {/* Episode Title */}
        <h1 className="text-white mb-6">Episode 4 - How I connect to audio</h1>

        {/* Episode Description */}
        <p className="text-[#f5f3ee] mb-8">
          Audio is the most personal interface. How listening becomes understanding, and why that aligns with the way I build digital experiences.
        </p>

        {/* Episode Image */}
        <div className="rounded-[25px] overflow-hidden mb-8">
          <img 
            src={imgChatGptImage28Okt20251518301}
            alt="Episode 4 - How I connect to audio"
            className="w-full h-auto object-cover"
          />
        </div>

        {/* Audio Player */}
        <div className="bg-[#ca444d] rounded-[17px] h-[80px] flex items-center gap-4 px-8">
          {/* Previous Button */}
